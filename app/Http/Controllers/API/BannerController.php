...
class BannerController extends Controllers\BaseController
{
    ...
    public function create(Request $request)
    {
        ...
        if(true){
            return $this->sendResponse(false, 200, null, 'Banner has been listed successfully.');
        }else{
            return $this->sendResponse(true, 233, null, 'Banner registration failed.');
        }
    ...
    public function delete(Request $request)
    {
        ...
        $query=DB::table('banners')->where('id', '=', $request->id)->delete();
