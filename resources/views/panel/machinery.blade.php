...
{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Machinery</button>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($Machineries as $MachineriesTemp)
                                        <tr>
                                            <td>{{$MachineriesTemp->created_at}}</td>
                                            <td>{{$MachineriesTemp->company_title}}</td>
                                            <td>{{$MachineriesTemp->child_category_title}}</td>
                                            <td>{{$MachineriesTemp->sub_child_category_title}}</td>
                                            <td>{{$MachineriesTemp->hourly_rate}}</td>
                                            <td>{{$MachineriesTemp->status}}</td>
                                            <td>
                                                {{--                                            <a href="javascript:void(0);" id="view_{{$MachineriesTemp->id}}" class="view"><i data-feather="eye"></i></a>--}}
                                                {{--                                            <a href="javascript:void(0);" id="edit_{{$MachineriesTemp->id}}" class="edit"><i data-feather="edit-2"></i></a>--}}


{{--                                                    <a href="javascript:void(0);" id="delete_{{$MachineriesTemp->id}}" class="delete"><i data-feather="trash-2"></i></a>--}}
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data['error']!=true){
                            ...
                            window.location.href= dataAppUrl+'/admin/users';
