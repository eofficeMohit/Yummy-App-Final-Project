...
{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Company</button>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($Companies as $CompaniesTemp)
                                        <tr>
                                            <td>{{$CompaniesTemp->created_at}}</td>
                                            <td>{{$CompaniesTemp->title}}</td>
                                            <td>{{$CompaniesTemp->about}}</td>
                                            <td>{{$CompaniesTemp->status}}</td>
                                            <td>
{{--                                                <a href="javascript:void(0);" id="view_{{$CompaniesTemp->id}}" class="view"><i data-feather="eye"></i></a>--}}
{{--                                                <a href="javascript:void(0);" id="edit_{{$CompaniesTemp->id}}" class="edit"><i data-feather="edit-2"></i></a>--}}
{{--                                                <a href="javascript:void(0);" id="delete_{{$CompaniesTemp->id}}" class="delete"><i data-feather="trash-2"></i></a>--}}
                                            </td>
                                        </tr>
                                    @endforeach
