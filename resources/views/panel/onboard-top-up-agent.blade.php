                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Onboard TopUp Agent</h4>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($Onboards as $OnboardsTemp)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{url('/sign-up/top-up-agent?code='.$OnboardsTemp->code)}}</td>
    ...
    <script>
        ...
        $('#submit').on('click',function (e) {
            ...
            if (valid_till !== '') {
                ...
                $.ajax({
                    url: dataApiUrl+'/onboard/top-up-agent/create',
                    data: fdata,
                    type: 'POST',
                    ...
                    success:function(data){
                        ...
                        if(data['error']!=true){
                            ...
                            window.location.href= dataAppUrl+'/admin/onboard/top-up-agent';
