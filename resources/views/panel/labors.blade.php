                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Labors</h4>

{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Labor</button>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($Labors as $LaborsTemp)
                                        <tr>
                                            <td>{{$LaborsTemp->created_at}}</td>
                                            <td>{{$LaborsTemp->user_full_name}}</td>
                                            <td>{{$LaborsTemp->user_number}}</td>
                                            <td>{{$LaborsTemp->cnic_number}}</td>
                                            <td>{{$LaborsTemp->daily_wages}}</td>
                                            <td>
                                                @if($LaborsTemp->created_by_user_id==null)
                                                    Direct
                                                @else
                                                    Indirect
                                                @endif
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Labor Registration</h5>
