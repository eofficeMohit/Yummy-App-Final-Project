...
{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Contact</button>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($Contacts as $ContactsTemp)
                                        <tr>
                                            <td>{{$ContactsTemp->created_at}}</td>
                                            <td>{{$ContactsTemp->name}}</td>
                                            <td>{{$ContactsTemp->email}}</td>
                                            <td>{{$ContactsTemp->subject}}</td>
                                            <td>{{$ContactsTemp->message}}</td>
                                            <td>
                                                {{--                                            <a href="javascript:void(0);" id="view_{{$ContactsTemp->id}}" class="view"><i data-feather="eye"></i></a>--}}
                                                {{--                                            <a href="javascript:void(0);" id="edit_{{$ContactsTemp->id}}" class="edit"><i data-feather="edit-2"></i></a>--}}
                                                <a href="javascript:void(0);" id="delete_{{$ContactsTemp->id}}" class="delete"><i data-feather="trash-2"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data['error']!=true){
                            ...
                            window.location.href= dataAppUrl+'/admin/contacts/list';
