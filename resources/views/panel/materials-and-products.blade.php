                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Materials & Products</h4>

{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Materials & Products</button>--}}
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($Users as $UsersTemp)
                                        <tr>
                                            <td>{{$UsersTemp->first_name}}</td>
                                            <td>{{$UsersTemp->last_name}}</td>
                                            <td>{{$UsersTemp->username}}</td>
                                            <td>{{$UsersTemp->email}}</td>
                                            <td>{{$UsersTemp->number}}</td>
                                            <td>{{$UsersTemp->user_type_title}}</td>
                                        </tr>
                                    @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Materials & Products Registration</h5>
