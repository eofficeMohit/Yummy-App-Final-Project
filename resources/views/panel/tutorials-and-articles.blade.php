                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tutorials and Articles</h4>

{{--                                <button type="button" class="btn btn-primary waves-effect waves-float waves-light"  data-toggle="modal" data-target="#exampleModalCenter">Add New Tutorials and Articles</button>--}}
...
{{--                                                    <a href="javascript:void(0);" id="delete_{{$UsersTemp->id}}" class="delete"><i data-feather="trash-2"></i></a>--}}
{{--                                                @endif--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                    @endforeach--}}
