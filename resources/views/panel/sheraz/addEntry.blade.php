                ...
                <div class="row" id="basic-table">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="container">
	<header class="header">
		<h1 id="title" class="text-center">Add Entry</h1>
	...
	<div class="form-wrap">	
		<form id="survey-form">
            ...
            <div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="file" name="json" id="name" class="" required>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<label id="email-label" for="email">Choose PNG Picture</label>
						<input type="file" name="picture" id="email" class="" required>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label id="number-label" for="number">Diamonds <small>(Weekly)</small></label>
						<input type="number" name="weeklyDiamonds" id="number" class="form-control" >
					</div>
				</div>
                <div class="col-md-6">
					<div class="form-group">
						<label id="number-label" for="number">Diamonds <small>(Two Weeks)</small></label>
						<input type="number" name="twoWeeks" id="number" class="form-control" >
					</div>
				</div>
                <div class="col-md-6">
					<div class="form-group">
						<label id="number-label" for="number">Diamonds <small>(Monthly)</small></label>
						<input type="number" name="monthly" id="number" class="form-control" >
					</div>
				</div>
                <div class="col-md-6">
					<div class="form-group">
						<label id="number-label" for="number">Diamonds <small>(Yearly)</small></label>
						<input type="number" name="yearly" id="number" class="form-control" >
					</div>
				</div>
                ...
                <div class="col-md-6">
					<div class="form-group">
						...
						<input type="file" name="backgroundMusic" id="number" class="">
					</div>
				</div>
