                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Send Diamond History</h4>
                                <!-- <a href="{{url('/admin/store/frame-add')}}" class="btn btn-success" data-toggle="modal" data-target="#addDiamodsModal">Add Diamonds</a> -->
...
<div class="modal fade" id="addDiamodsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   ...
   <select class="form-control form-control-xs selectpicker" name="" data-size="7" data-live-search="true" data-title="Location" id="state_list" data-width="100%">
       ...
       <input type="number" class="form-control" placeholder="Number of Diamonds">
      </div>
