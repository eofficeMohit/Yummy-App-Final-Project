                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                ...
                                <input type="text" id="reference_code" class="form-control" value="{{$agency_code}}" placeholder="Admin Code*" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="20">
