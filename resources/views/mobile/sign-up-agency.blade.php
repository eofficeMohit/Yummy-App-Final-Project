...
<section class="background-2">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-2" style="color: whitesmoke">




                {{-- Step 0 --}}
                <div id="step0" style="display: block" class="mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="text-white ch-6 fb-b mb-3 mt-2 text-center">
                                Sign Up for Agency
                            </div>


                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                <label for="reference_code">Admin Code*</label>
                                <input type="text" id="reference_code" class="form-control" value="{{$admin_code}}" placeholder="Admin Code*" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="20">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="email_address" class="form-control" placeholder="Email Address*" maxlength="50">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <div class="input-group cus-bor-1 bg-color-31 rounded-3">
                                        <input type="password" class="form-control text-white bg-transparent border-0 input-focus" id="password" placeholder="Enter Password" maxlength="60">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="full_name" class="form-control" placeholder="Name*" oninput="this.value = this.value.replace(/[^a-zA-Z .]/g, '').replace(/(\..*)\./g, '$1');" maxlength="60">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-4 cus-form-1">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="address_1" class="form-control" placeholder="Street Address Line 1" maxlength="40">
                                    <small id="address_1_alert" style="color: red;"></small>
                                </div>

                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    <label for="address_2">Address 2</label>
                                    <input type="text" id="address_2" class="form-control" placeholder="Street Address Line 2" maxlength="40">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6 mt-2">
                                    ...
                                    <div class="text-center account-created-box-2" style=" height: 150px;  background-color: #0b5661">

                                        <div class="upload-section-front" style="display: block; padding-top: 50px;">

                                            <i class="fas fa-camera ch-6"> Upload Photo
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="id_number" class="form-control" placeholder="Enter Prove of ID Number*">
                            ...
                            <div class="ch-7 fb mt-3">Ensure that the document meet all the standard below:</div>

                            <div class="account-created-bullet mt-3 ch-7">
                                <ul>
                                    <li>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="company_name" class="form-control" placeholder="Company Name (Optional)" maxlength="70">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="company_registration_number" class="form-control" placeholder="Company Registration Number (Optional)" maxlength="40">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="company_address_1" class="form-control" placeholder="Street Address Line 1" maxlength="40">
                                    <small id="company_address_1_alert" style="color: red;"></small>
                                </div>

                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    <label for="company_address_2">Address 2</label>
                                    <input type="text" id="company_address_2" class="form-control" placeholder="Street Address Line 2" maxlength="40">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="iban" class="form-control" placeholder="Enter IBAN*">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="swift_bic_code" class="form-control" placeholder="Enter Swift Code / BIC*">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="branch_code" class="form-control" placeholder="Enter Branch Code">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3 cus-form-1">
                                    ...
                                    <input type="text" id="account_title" class="form-control" placeholder="Enter Account Title*">
                ...
                <div id="step6" style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto mt-3">
                            ...
                            <div style="height: calc(100vh - 250px);" class="dropdown-menu-scroll-box scroll mt-4">

                                {!! $Settings->admin_terms_and_conditions !!}
                ...
                <div id="step7" style="display: none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto text-center">
                            ...
                            <div id="link" style="background-color: #573e3e; border-radius: 10px; margin-top: 30px; padding: 20px; font-weight: bolder; cursor: pointer; margin-bottom: 50px;">
                                https://banolive.com/sign-up/agency
                            </div>


                            <div style="text-align: center"><a href="{{url('/mobile/sign-in')}}" class="btn btn-danger rounded-pill">Sign In to Your Account</a></div>
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if(data['error']!=true){
                        ...
                        $('#link').html('').append(data['data'].code);
    ...
    $("#move_step1").click(function(){
        ...
        if (reference_code === '') {
            ...
            if (validatenum(reference_code)) {
                ...
                $.ajax({
                    url: dataApiUrl+'/user/validate/admin/code',
                    data: fdata,
                    type: 'POST',
                    timeout: 300000, //Set your timeout value in milliseconds or 0 for unlimited
                    dataType:'json',
