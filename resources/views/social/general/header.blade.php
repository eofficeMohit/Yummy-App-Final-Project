        ...
        <div class="d-flex bd-highlight">
            <div class="pt-2 pb-1 pe-2 bd-highlight">
                <a href="{{ url('/') }}">
                    <div class="logo-header">
                        <img src="{{ url('/general/img/general/icons/favicon-32x32.png') }}" alt="">
                    </div>
                </a>
            </div>
            ...
            <div class="pt-3 pb-1 flex-grow-1 w-100 bd-highlight social-media-menu">
                ...
                <div class="dropdown">
                    ...
                    @if ($User->image != null)
                        <img src="{{ url('/uploads/' . $User->image) }}" alt=""
                            class="rounded-circle bg-light socialP-head-icon-box img-fit dropdown-toggle"
                            id="profile_avatar_top" data-bs-toggle="dropdown" aria-expanded="false">
                    @else
                                ...
                                <div class="d-flex bd-highlight">
                                    <div class="bd-highlight ms-2">
                                        <div class="rounded-circle bg-light socialP-head-icon-box float-start">
                                            ...
                                            @if ($User->image != null)
                                                <img src="{{ url('/uploads/' . $User->image) }}" alt=""
                                                    class="rounded-circle bg-light socialP-head-icon-box img-fit ">
                                            @else
                                                <img src="{{ url('/general/img/default-user.jpg') }}" alt=""
                                                    class="rounded-circle bg-light socialP-head-icon-box img-fit ">
                                            @endif
                        ...
                        <li>
                            <a class="dropdown-item" href="{{ url('/sign-out') }}">
                                <div class="d-flex bd-highlight">
                                    <div class="bd-highlight">
                                        <div class="rounded-circle bg-light float-start p-2">
                                            <img src="{{ url('/general/img/icons/social-icon-27.svg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="bd-highlight ms-2 mt-2">
                ...
                <div class="rounded-circle bg-light socialP-head-icon-box me-2">
                    <a href="{{ url('/newsfeed') }}"><img src="{{ url('/general/img/icons/social-icon-04.svg') }}"
                            alt=""></a>
                </div>
