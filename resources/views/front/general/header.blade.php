        ...
        <div class="container-fluid">
            <a class="navbar-brand d-none d-sm-block" href="{{ url('/') }}">
                <div class="logo-header">
                    <img src="{{ url('general/icons/favicon-32x32.png') }}">
                </div>
            </a>
                        ...
                        @if ($is_session)
                            <li class="nav-item dropdown d-none d-sm-block">
                                <a class="nav-link d-sm-flex align-items-sm-center" href="#"
                                    data-bs-toggle="dropdown" style="padding: 0; color: black">
                                    ...
                                    @if ($User->image != null)
                                        <img src="{{ url('/uploads/' . $User->image) }}" id="profile_avatar_top"
                                            class="rounded-circle"
                                            style="height: 35px; width: 35px; object-fit: cover; border: 1px solid #010716;">
                                    @else
                                        <img src="{{ url('/general/img/default-user.jpg') }}" id="profile_avatar_top"
                                            class="rounded-circle"
                                            style="height: 35px; width: 35px; object-fit: cover; border: 1px solid #010716;">
                                    @endif
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" style="width: 100%; border: 0px;">
                                    <li><a class="dropdown-item" href="{{ url('/newsfeed') }}"><i
                                                class="fas fa-home fa-sm"></i> Newsfeed</a></li>
                                    <li><a class="dropdown-item" href="{{ url('/profile') }}"><i
                                                class="fas fa-user fa-sm"></i> Profile</a></li>
                                    <li><a class="dropdown-item" href="{{ url('/settings') }}"><i
                                                class="fas fa-cog fa-sm"></i> Settings</a></li>
                                    <li>
                                        <hr class="dropdown-divider" style="border-top: 1px solid lightgray;">
                                    </li>
                                    <li><a class="dropdown-item" href="{{ url('/sign-out') }}"><i
                                                class="fas fa-sign-out-alt fa-sm"></i> Sign Out </a></li>
                                </ul>
                            </li>
                        @else
