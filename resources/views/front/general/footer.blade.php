    ...
    <div class="container-fluid">
        <div class="d-flex bd-highlight">
            ...
            <div class="ms-auto bd-highlight">
                <ul>
                    <a href="{{ $Settings->facebook_link }}" class="btn social-link-footer m-1"><i class="fab fa-facebook-f"></i></a>
                    <a href="{{ $Settings->twitter_link }}" class="btn social-link-footer m-1"><i class="fab fa-twitter"></i></a>
                    <a href="{{ $Settings->linkedin_link }}" class="btn social-link-footer m-1"><i class="fab fa-linkedin-in"></i></a>
                    <a href="{{ $Settings->instagram_link }}" class="btn social-link-footer m-1"><i class="fab fa-instagram"></i></a>
                </ul>
            </div>
        </div>
    </div>
