                ...
                <div id="step0" style="display: block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="ch-1 text-dark text-center">Sign Up for Admin</div>


                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3">
                                <label for="reference_code">Country Head Code*</label>
                                <input type="text" id="reference_code" class="form-control form-control-lg" value="{{$country_head_code}}" placeholder="Country Head Code*">
    ...
    $("#move_step1").click(function(){
        ...
        if (reference_code === '') {
            ...
            if (validatenum(reference_code)) {
                ...
                $.ajax({
                    url: dataApiUrl+'/user/validate/country-head/code',
                    data: fdata,
                    type: 'POST',
                    timeout: 300000, //Set your timeout value in milliseconds or 0 for unlimited
                    dataType:'json',
