    ...
    <div class="container">
        <div class="row">
            ...
            <div class=" col-sm-6 col-md-6 col-lg-6 col-6 mb-3">
                <div class="gallery-box bg-black position-relative">
                    <div class="over-lay"></div>
                    <img src="{{url('/general/img/gallery/album-image-01.jpg')}}" alt="" class="rounded img-fit w-100 h-100">
                    <div class="explore-icon">
                        <div class="d-flex bd-highlight position-absolute top-50 start-0 w-100">
                            <div class="d-flex bd-highlight mx-auto">
                                <div class="p-2 flex-fill bd-highlight">
                                    <img src="{{url('/general/img/icons/social-icon-20.svg')}}"><span class="ch5 text-white "> 55.2K</span>
                                </div>
                                <div class="p-2 flex-fill bd-highlight">
                                    <img src="{{url('/general/img/icons/social-icon-21.svg')}}"><span class="ch5 text-white"> 15.2k</span>
                                </div>
                                <div class="p-2 flex-fill bd-highlight">
                                    <img src="{{url('/general/img/icons/social-icon-22.svg')}}"><span class="ch5 text-white"> 1.2k</span>
                                </div>
                            </div>
                        </div>
                    </div>
