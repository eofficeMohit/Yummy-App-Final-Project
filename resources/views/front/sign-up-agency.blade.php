                ...
                <div id="step0" style="display: block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div class="ch-1 text-dark text-center">Sign Up for Agency</div>


                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3">
                                <label for="reference_code">Admin Code*</label>
                                <input type="text" id="reference_code" class="form-control form-control-lg" value="{{$admin_code}}" placeholder="Admin Code*">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                            ...
                            <div style="height: calc(100vh);" class="dropdown-menu-scroll-box scroll mt-4">
                                ...
                                {!! $Settings->agency_terms_and_conditions !!}
