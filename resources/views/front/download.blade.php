        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                    <img src="{{ url('/general/icons/favicon-32x32.png') }}" class="mt-5">
                    <div class="ch-1">Live Your Moments</div>
                    <div class="ch-6">Live Stream. Live Video. Live Chat. Make Friends</div>
                    <div class="mt-5">
                        <a href="{{ $Settings->appstore_link }}"><img
                                src="{{ url('/general/img/app-button.svg') }}"></a>
                        <a href="{{ $Settings->playstore_link }}"><img
                                src="{{ url('/general/img/play-button.svg') }}"></a>
                    </div>
                    ...
                    error: function(xmlhttprequest, textstatus, message) {
                        ...
                        if (textstatus === "timeout") {
                            ...
                            if (navigator.onLine) {
                                ...
                                $("#alert").css("display", "block").text(
                                    'Check your internet connection then try again later.');
                            }
                        }
