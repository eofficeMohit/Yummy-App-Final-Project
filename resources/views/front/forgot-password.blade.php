    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                ...
                <div class="ch-1 text-dark text-center">Forgot Password</div>
                <div class="ch-7 text-muted text-dark text-center">Please Enter Your Email Or Phone</div>
                ...
                <form class="row  mt-4 mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <input type="text" class="form-control form-control-lg mt-4" placeholder="Enter Email Or Phone">
                    </div>
