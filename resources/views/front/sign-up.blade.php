            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mx-auto mt-5 mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-2">
                        ...
                        <a href="{{url('/sign-up/country-head')}}" style="text-decoration: none; font-weight: bold; color: red">
                            <div class="card p-4 text-center" style="background-color: #f9f9f9; border: 1px solid #f9f9f9;">

                                <img src="{{url('panel/images/country-head.svg')}}" alt="" title="" style="width: 100px; height: 100px; margin: 0 auto">

                                <div class="mt-4">Sign Up As Country Head</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 mt-2">
                        ...
                        <a href="{{url('/sign-up/admin')}}" style="text-decoration: none; font-weight: bold; color: red">
                            <div class="card p-4 text-center" style="background-color: #f9f9f9; border: 1px solid #f9f9f9;">
                                ...
                                <img src="{{url('panel/images/admin.svg')}}" alt="" title="" style="width: 100px; height: 100px; margin: 0 auto">

                                <div class="mt-4">Sign Up As Admin</div>
