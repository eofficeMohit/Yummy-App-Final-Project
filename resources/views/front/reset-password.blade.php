    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mx-auto">
                ...
                <div class="ch-1 text-dark text-center">New Password</div>
                <div class="ch-7 text-muted text-dark text-center">Strong passwords include numbers, letters, and punctuation marks.</div>
                ...
                <form class="row  mt-4 mb-4">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <input type="text" class="form-control form-control-lg mt-2" placeholder="New Password">
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 m-2">
                        <input type="text" class="form-control form-control-lg mt-4" placeholder="Confrim Password">
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-2">
                        <button type="submit" class="btn btn-danger w-100 m-auto mt-4 mb-4">SAVE PASSWORD</button>
                    </div>

                    <div class="ch-7 text-muted text-dark text-center">Don’t Forgot Password? <a href="" class="text-dark fb">Login</a></div>
